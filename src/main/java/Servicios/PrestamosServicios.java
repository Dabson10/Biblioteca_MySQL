...
//        if(!disponible){
//            System.out.println("El ejemplar seleccionado no esta disponible.");
//            return;
//        }
...
//
//        System.out.println("Se prestara el ejemplar " + ejemplar.mostrarDatos() +
...
//        System.out.println("La fecha de regreso es: " + fechaRegreso);
        ...
        //Ahora si se realizara la consulta del prestamo.
//        String usuarioID = persona.getPersonaID();
